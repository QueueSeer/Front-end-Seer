    ...
    <div className="bg-gray-50">
      ...
      <div className="min-h-screen md:min-h-[80vh] flex flex-col">
        ...
        <div className="container mx-auto px-4 py-12 flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 text-left">
            <h1
              className="font-playfair-display text-[64px] font-bold text-[#8677A7]"
              style={{ fontFamily: "Playfair Display" }}
            >
              Qseer
            </h1>
            <p
              className="text-[50px] font-semibold text-black"
              style={{ fontFamily: "Noto Sans Thai" }}
            >
              ผู้ช่วยอัจฉริยะสำหรับหมอดู
            </p>
            <p
              className="text-[50px] font-semibold text-[#8677A7]"
              style={{ fontFamily: "Noto Sans Thai" }}
            >
              ยกระดับการจัดการคิว
            </p>
            ...
            <p
              className="text-[19px] font-normal text-black mt-6 leading-relaxed"
              style={{ fontFamily: "Noto Sans Thai" }}
            >
              Qseer ช่วยให้หมอดูจัดการคิวลูกค้าได้อย่างง่ายดาย
              ช่วยเพิ่มความสะดวกในการ
              <br />
              วางแผนการทำงาน
      ...
      <div className="bg-gray-50 py-6">
        <div className="text-center mb-8 md:mb-10">
          <h2
            className="text-[#8677A7] text-2xl font-semibold"
            style={{ fontFamily: "Noto Sans Thai" }}
          >
            เพิ่มความง่าย
          </h2>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p
                    ...
                    style={{ fontFamily: "Noto Sans Thai" }}
                  >
                    ระบบจะอำนวยความสะดวกในการจัดการคิวโดยอัตโนมัติ
                    หมอดูสามารถปรับแต่งตารางการทำงาน ของตนเองได้ตามความต้องการ
                    และความพร้อมในการให้บริการลูกค้า
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p
                    ...
                    style={{ fontFamily: "Noto Sans Thai" }}
                  >
                    หมอดูจะได้รับการแจ้งเตือนล่วงหน้าก่อนนัดหมายเกิดขึ้น
                    เพื่อให้มีเวลาเตรียมตัว และวางแผนการให้บริการได้อย่างเหมาะสม
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p
                    ...
                    style={{ fontFamily: "Noto Sans Thai" }}
                  >
                    เมื่อมีลูกค้าทำการจองคิวใหม่ หมอดูจะได้รับการแจ้งเตือนทันที
                    ช่วยให้ทราบถึงการเพิ่มขึ้นของนัดหมาย
                    และจัดการตารางเวลาได้ทันท่วงที
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p
                    ...
                    style={{ fontFamily: "Noto Sans Thai" }}
                  >
                    หากลูกค้าต้องการยกเลิกหรือเปลี่ยนแปลงเวลานัดหมาย
                    ระบบจะส่งการแจ้งเตือนทันทีถึงหมอดู
                    ช่วยให้สามารถปรับแผนหรือตอบรับการเปลี่ยนแปลงได้อย่างรวดเร็ว
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p
                    ...
                    style={{ fontFamily: "Noto Sans Thai" }}
                  >
                    แสดงรายการคิวนัดหมายของหมอดูที่กำลังจะเกิดขึ้นและคิวที่กำลังรออยู่
                    ซึ่งจะอัปเดตสถานะอย่างต่อเนื่อง เช่น คิวที่กำลังดำเนินการ,
                    คิวที่กำลังรอ, และคิวที่เสร็จสิ้น
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p
                    ...
                    style={{ fontFamily: "Noto Sans Thai" }}
                  >
                    แสดงสถานะการออนไลน์หรือพร้อมให้บริการของหมอดู
                    ช่วยให้ลูกค้าทราบได้ว่าหมอดู พร้อมให้บริการหรือไม่ในเวลานั้น
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p
                    ...
                    style={{ fontFamily: "Noto Sans Thai" }}
                  >
                    ระบบจะอัปเดตและแจ้งเตือนหมอดูเกี่ยวกับการเปลี่ยนแปลงใด ๆ
                    ในนัดหมายที่ลูกค้าทำ เช่น การยกเลิกหรือเปลี่ยนเวลานัดหมาย
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="bg-gray-50 py-12 md:py-16">
        <div className="container mx-auto px-4 flex flex-col md:flex-row-reverse items-center gap-8">
          ...
          <div className="w-full md:w-1/2 text-left">
            {/* Section Title */}
            <h2
              className="text-[#8677A7] text-lg sm:text-xl md:text-2xl font-semibold mb-4"
              style={{ fontFamily: "Noto Sans Thai" }}
            >
              ค้นพบฟีเจอร์ที่แตกต่าง
            </h2>
            <h3
              className="text-black text-xl sm:text-2xl md:text-4xl font-semibold mb-6"
              style={{ fontFamily: "Noto Sans Thai" }}
            >
            ...
            {/* Description */}
            <p
              className="text-gray-700 text-sm sm:text-base md:text-lg font-medium leading-relaxed mb-8"
              style={{ fontFamily: "Noto Sans Thai" }}
            >
              Qseer
              สร้างประสบการณ์ใหม่ให้กับทั้งหมอดูและผู้ใช้บริการด้วยคุณสมบัติที่ล้ำสมัย
              พัฒนาการให้บริการที่เหนือระดับ
              ด้วยฟีเจอร์เฉพาะที่ตอบโจทย์ความต้องการของหมอดู โดยเฉพาะ
              และสนับสนุนการเติบโตของธุรกิจดูดวงของคุณ
            </p>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg p-6 shadow-md flex items-start">
                <img
                  src={images.Augtion}
                  alt="Auction Icon"
                  className="w-12 sm:w-14 mr-4 flex-shrink-0"
                />
                <div>
                  <h4
                    className="text-[#8677A7] text-sm sm:text-base md:text-lg font-bold mb-2"
                    style={{ fontFamily: "Noto Sans Thai" }}
                  >
                    ประมูลคิวดูดวง
                  </h4>
                  <p
                    className="text-gray-700 text-xs sm:text-sm md:text-base font-medium"
                    style={{ fontFamily: "Noto Sans Thai" }}
                  >
                    ช่วยหมอดูในการเข้าถึงลูกค้าใหม่ๆ
                    และสร้างรายได้จากการประมูลเพื่อดูดวงให้ลูกค้าที่สนใจที่สุด
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md flex items-start">
                <img
                  src={images.InstantHoroscope}
                  alt="Instant Horoscope Icon"
                  className="w-12 sm:w-14 mr-4 flex-shrink-0"
                />
                <div>
                  <h4
                  ...
                  <p
                    ...
                    style={{ fontFamily: "Noto Sans Thai" }}
                  >
                    เสริมสร้างความสามารถในการให้บริการลูกค้าอย่างรวดเร็ว
                    โดยไม่ต้องใช้การนัดหมายล่วงหน้า
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md flex items-start">
                <img
                  src={images.HoroscopeScience}
                  alt="Horoscope Science Icon"
                  className="w-12 sm:w-14 mr-4 flex-shrink-0"
                />
                <div>
                  <h4
                  ...
                  <p
                    ...
                    style={{ fontFamily: "Noto Sans Thai" }}
                  >
                    สำรวจหมอดูตามศาสตร์ ค้นหาตามความเชี่ยวชาญ
                    เพิ่มโอกาสในการถูกเลือกโดยลูกค้าที่สนใจศาสตร์นั้นๆ
                  </p>
                </div>
              </div>
            </div>

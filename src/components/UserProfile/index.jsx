...
const Profile = () => {
  return (
    <div className="px-8 pt-6 mx-auto bg-white border rounded-lg shadow-md">
      ...
      <div className=" py-8 grid grid-cols-2  px-[30px] ">
        ...
        <div className="text-base">
          <h2 className="text-xl text-gray-800 font-semibold mb-4">ข้อมูลส่วนตัว</h2>
          <div className="space-y-2">
            <div className="flex">
              <div className="w-32 font-medium text-black">ชื่อหมอดู</div>
              <div>เพียงฟ้า พาขชัย</div>
            </div>
            <div className="flex">
            ...
            <div className="flex">
              <div className="w-32 font-medium text-black">
                วันเดือนปีเกิด
              </div>
